...
const AUTH_ERROR_MESSAGES: Record<string, string> = {
  OTP_INVALID: 'Código inválido. Confira o código enviado no WhatsApp.',
  OTP_EXPIRED: 'O código expirou. Solicite um novo pelo WhatsApp.',
  OTP_RESEND_COOLDOWN: 'Aguarde alguns segundos para reenviar o código.',
  OTP_SEND_FAILED: 'Não foi possível enviar o código no WhatsApp. Tente novamente.',
  PHONE_INVALID: 'Número de WhatsApp inválido.',
  PHONE_REQUIRED: 'Informe seu número de WhatsApp.',
};
